        ...
        <Container>
            <div className="row">
                <div className="mt-5 col-md-6">
                    <h4 className="mt-3">Developed By: <b style={{ fontFamily: "Permanent Marker"}}>Ryan Hardy</b></h4>
                    <h4 className="mt-3">
                        Portfolio: <b style={{ fontFamily: "Permanent Marker"}}>
                            <a href="https://www.rh-web-design.co.uk/" target="_blank" className="text-dark">
                                My Porfolio
                            </a>
                        </b>
                    </h4>
                    <h4 className="mt-3">
                        GitHub: <b style={{ fontFamily: "Permanent Marker"}}>
                            <a href="https://github.com/Ryan-Hardy-Dev" target="_blank" className="text-dark">
                                My GitHub
                            </a>
                        </b>
                    </h4>
